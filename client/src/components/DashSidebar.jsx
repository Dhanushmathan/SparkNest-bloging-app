...
const DashSidebar = () => {
    ...
    return (
        <div className="">
            ...
            <div className={`fixed inset-y-0 ${isOpen ? 'top-[91px]' : 'top-12'} left-0 z-30 ${isOpen ? 'w-[200px] md:w-64' : 'w-0 md:w-64'} md:static md:h-screen h-full md:bg-gray-200 text-gray-800 flex flex-col transition-all duration-300 shadow-lg md:shadow-none overflow-hidden ${isOpen ? 'bg-gray-200' : 'bg-transparent'} md:bg-gray-200`}>
